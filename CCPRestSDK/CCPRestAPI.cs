...
namespace CCPRestSDK
{
    ...
    public class CCPRestAPI
    {
        ...
        string restIp = ConfigurationManager.AppSettings["RestIp"];
        string restNum = ConfigurationManager.AppSettings["RespNum"];

        public CCPRestAPI()
        {
            IsInit = init(restIp, restNum);

            setAccount(accountSid, authToken);
