...
* Ver    变更日期             负责人  变更内容
* ───────────────────────────────────
* V0.01  2017/4/23 10:39:07   N/A    初版
*
...
namespace Vanyin.DAL
{
	...
	public partial class Technology
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Vanyin.Model.Technology model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tb_Technology(");
			strSql.Append("NumId,Title,SubTitle,TypeId,Describe,ImgUrl,Explain,IsHot,IsRec,IsIndex,StateInfo,SortNum,Remark)");
			...
			parameters[6].Value = model.Explain;
			parameters[7].Value = model.IsHot;
			parameters[8].Value = model.IsRec;
			parameters[9].Value = model.IsIndex;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Vanyin.Model.Technology model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Vanyin.Model.Technology GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,NumId,Title,SubTitle,TypeId,Describe,ImgUrl,Explain,IsHot,IsRec,IsIndex,StateInfo,SortNum,Remark from tb_Technology ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Vanyin.Model.Technology DataRowToModel(DataRow row)
		{
			Vanyin.Model.Technology model=new Vanyin.Model.Technology();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,NumId,Title,SubTitle,TypeId,Describe,ImgUrl,Explain,IsHot,IsRec,IsIndex,StateInfo,SortNum,Remark ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,NumId,Title,SubTitle,TypeId,Describe,ImgUrl,Explain,IsHot,IsRec,IsIndex,StateInfo,SortNum,Remark ");
			strSql.Append(" FROM tb_Technology ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
