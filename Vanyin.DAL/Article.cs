...
namespace Vanyin.DAL
{
	...
	public partial class Article
	{
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Vanyin.Model.Article model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into tb_Article(");
			strSql.Append("Num,Title,SubTitle,TypeId,StrKey,Describe,Abstract,Introduction,Author,SourceInfo,ImgUrl,Content,StateInfo,Attribute,AddTime)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Vanyin.Model.Article model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Vanyin.Model.Article GetModel(int Id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Id,Num,Title,SubTitle,TypeId,StrKey,Describe,Abstract,Introduction,Author,SourceInfo,ImgUrl,Content,StateInfo,Attribute,AddTime from tb_Article ");
			strSql.Append(" where Id=@Id");
			SqlParameter[] parameters = {
					new SqlParameter("@Id", SqlDbType.Int,4)
			};
			...
			Vanyin.Model.Article model=new Vanyin.Model.Article();
		...
		/// 得到一个对象实体
		/// </summary>
		public Vanyin.Model.Article DataRowToModel(DataRow row)
		{
			Vanyin.Model.Article model=new Vanyin.Model.Article();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Id,Num,Title,SubTitle,TypeId,StrKey,Describe,Abstract,Introduction,Author,SourceInfo,ImgUrl,Content,StateInfo,Attribute,AddTime ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" Id,Num,Title,SubTitle,TypeId,StrKey,Describe,Abstract,Introduction,Author,SourceInfo,ImgUrl,Content,StateInfo,Attribute,AddTime ");
			strSql.Append(" FROM tb_Article ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
