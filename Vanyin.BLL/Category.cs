...
namespace Vanyin.BLL
{
	...
	{
		private readonly Vanyin.DAL.Category dal=new Vanyin.DAL.Category();
		public Category()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<Vanyin.Model.Category> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Vanyin.Model.Category> DataTableToList(DataTable dt)
		{
			List<Vanyin.Model.Category> modelList = new List<Vanyin.Model.Category>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Vanyin.Model.Category model;
