...
namespace Vanyin.BLL
{
	...
	{
		private readonly Vanyin.DAL.S_City dal=new Vanyin.DAL.S_City();
		public S_City()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 获得数据列表
		/// </summary>
		public List<Vanyin.Model.S_City> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Vanyin.Model.S_City> DataTableToList(DataTable dt)
		{
			List<Vanyin.Model.S_City> modelList = new List<Vanyin.Model.S_City>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Vanyin.Model.S_City model;
