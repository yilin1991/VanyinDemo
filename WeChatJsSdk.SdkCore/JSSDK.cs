...
namespace WeChatJsSdk.SdkCore
{
    ...
    public class JSSDK
    {
        ...
        private string GetAccessToken()
        {
            ...
            WriteTextLog("Token", token.ToString(), DateTime.Now);
            return token.ToString();
        }
        ...
        private string GetJsApiTicket()
        {
            ...
            WriteTextLog("Token", ticket.ToString(), DateTime.Now);
            return ticket.ToString();
        }
        /// <summary>
        /// 获取jssdk签名配置对象
        ...
        public SignPackage GetSignPackage(string url, JsApiEnum jsapi)
        {
            ...
            WriteTextLog("result", "appId:"+ appId+ "   timestamp:"+ timestamp+ "  _debug:"+ _debug, DateTime.Now);
